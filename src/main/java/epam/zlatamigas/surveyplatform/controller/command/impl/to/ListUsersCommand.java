...
import static epam.zlatamigas.surveyplatform.controller.command.SearchParameter.DEFAULT_ORDER;
...
public class ListUsersCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try{
            List<User> users = service.findUsersBySearch(0, 0, "", DEFAULT_ORDER);
